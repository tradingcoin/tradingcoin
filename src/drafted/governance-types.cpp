...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TradingCoinNetwork") type = TradingCoinNetwork;
    if(strType == "TradingCoinNetworkVariable") type = TradingCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TradingCoinNetwork) s = "TradingCoinNetwork";
    if(type == TradingCoinNetworkVariable) s = "TradingCoinNetworkVariable";
