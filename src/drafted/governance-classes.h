 ...
 *
 *   // network
 *   CTradingCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.tradingcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTradingCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CTradingCoinNetwork(UniValue objIn)
    {
...
// // can be under: TradingCoinNetwork
// //   -- signature requirements : Key1(User)
// class CTradingCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == TradingCoinNetwork);
//     // }
