...
#define BOOST_TEST_MODULE TradingCoin Test Suite

#include "test_tradingcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_tradingcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
