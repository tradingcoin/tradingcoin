    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TDC-light"), QVariant("light"));
    ui->theme->addItem(QString("TDC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TDC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TDC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TDC-traditional"), QVariant("trad"));
