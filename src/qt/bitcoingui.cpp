    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("TradingCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TradingCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tradingcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About TradingCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TradingCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TradingCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TradingCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TradingCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a tradingcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TradingCoin Core help message to get a list with possible TradingCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("TradingCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TradingCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("TradingCoin Core"); // default title
    ...
    // Append title to "TradingCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
