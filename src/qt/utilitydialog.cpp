    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("TradingCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About TradingCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  tradingcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the TradingCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TDC, 0.1 TDC, 1 TDC and 10 TDC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://tradingcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://tradingcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("TradingCoin Core is shutting down...") + "<br /><br />" +
