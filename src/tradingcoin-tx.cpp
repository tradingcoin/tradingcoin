...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("TradingCoin Core tradingcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tradingcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tradingcoin transaction") + "\n" +
              "  tradingcoin-tx [options] -create [commands]   " + _("Create hex-encoded tradingcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tradingcoin transaction
