...
This mechanism has been integrated into Bitcore-Node-TradingCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tradingcoinpay/insight-api-tradingcoin#web-socket-api](https://github.com/tradingcoinpay/insight-api-tradingcoin#web-socket-api)
* API: [https://github.com/tradingcoinpay/insight-api-tradingcoin#instantsend-transactions](https://github.com/tradingcoinpay/insight-api-tradingcoin#instantsend-transactions)
...
By default, the TradingCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TradingCoin Core daemon:
