...
Only requiring some minor changes is tradingcoin.cpp.
...
Changes to tradingcoin.cpp
----------------------
tradingcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
