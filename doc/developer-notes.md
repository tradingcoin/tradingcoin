...
TradingCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 7777.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 7778 for connections and services them.
...
However, in open source software such as TradingCoin Core, where everyone uses
...
pay attention to for reviewers of TradingCoin Core code.

General TradingCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: TradingCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
